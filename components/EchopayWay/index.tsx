  ...
  const ways = [
    {
      ...
      span: "col-span-1 lg:col-span-2 w-full lg:w-[90%]",
      img: "/wayOne.svg",
      imgWidth: "hidden md:block lg:block",
    },
    {
        ...
        {ways.map((way, index) => (
          ...
          >
            <div className="self-center">
              ...
              <h3 className="mb-2 lg:mb-3 font-medium text-sm lg:text-base tracking-[-0.31px] text-[#010721]">
                {way.title}
              </h3>
            ...
            <img
              src={way.img}
              className={`${way.imgWidth} md:w-[30%] lg:w-[45%]`}
              alt=""
            />
          </div>
        ))}

...
const Developers = () => {
  ...
  return (
    <div className="pb-32 pt-20 font-inter">
      <div className="max-w-[73rem] mx-auto px-4 flex flex-col gap-4 items-center text-center mb-14">
      ...
      <div className="w-full bg-[url(/backgroundWave.svg)] py-[67px]">
        <div className="max-w-[73rem] mx-auto px-4">
          <div className="flex items-center">
            <div className="w-full flex flex-col gap-6">
              ...
              <div>
                <h1 className="font-normal text-5xl leading-[48px] tracking-[0.35px] text-white mb-3">
                  <div>Integrate once.</div>
                  <span className="bg-gradient-to-b bg-clip-text from-[#00BBFF] to-[#8FC6EB] text-transparent">
                    Scale infinitely.
                  </span>
                </h1>
                <p className="font-normal text-sm tracking-[-0.44px] text-[#CAD5E2] max-w-[23rem]">
              ...
              <div className="flex flex-col gap-4">
                {devFeatures.map((d, index) => (
                  <div
                    key={index}
                    className="w-[401px] p-[12px] flex items-start gap-2 rounded-lg bg-gradient-to-br from-[#0f1a40] to-[#BAE3FF14] border-[0.5px] border-t-[#c3d5fa] border-b-[#6a7ca1] border-x-[#43557b] shadow-[0px_1px_5px_0px_rgba(0,0,0,0.49)]"
                  >
                    <div>{ECHOPAY_SVG().doubleCheck()}</div>
                    <div className="flex flex-col gap-1">
                      <p className="font-normal text-base tracking-[-0.31px] text-white">
                        {d.title}
                      </p>
                      <p className="font-normal text-sm tracking-[-0.15px] text-[#90A1B9]">
                        {d.desc}
                      </p>
                    </div>
                  </div>
              ...
              <Button className="w-[176px] h-[56px] rounded-[10px] bg-white font-medium text-sm tracking-[-0.15px] text-[#010721]">
                View API Docs
              </Button>
            </div>
